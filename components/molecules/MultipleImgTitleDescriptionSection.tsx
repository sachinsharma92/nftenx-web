      ...
      <div className="order-1 lg:w-[50%]">
        <div className="lg:sticky top-16 mb-12">
          {props.mainSection?.image && (
            <div className="relative block after:block after:absolute after:bottom-0 after:left-0 after:w-full after:h-[30%] after:bg-gradient-to-t after:from-primary-1 after:via-primary-2 after:to-transparent">
              <img
