      ...
      <div className="-px-section pl-6 lg:px-32 flex flex-row flex-nowrap overflow-x-auto styled-scrollbar mt-16 gap-8 py-5">
        {props.items?.map((element, index) => {
          return (
            <div
              key={index}
              className="relative shrink-0 py-8 px-10 bg-[#BBC3DA] bg-opacity-5 border-white border-[1px] border-opacity-20 rounded-3xl text-secondary-1 w-[90vw] lg:w-[600px]"
            >
