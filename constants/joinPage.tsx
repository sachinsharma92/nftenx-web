...
export const section3 = {
  ...
  description:
    "The NF10x community is built with a hands-on approach to onboarding. Every two weeks, we welcome a new cohort of members into the fold. These smaller groups foster an environment that is more conducive to building genuine relationships while integrating into the broader community. Our first cohort will receive our Founding Members token and be added to a dedicated channel only available to Founding Members. Subsequent cohorts will mint General Member tokens until the community grows to 1,100 members. Those who signup for the waitlist get access to the first three events at no cost.",
  image: generalCoin.src,
  items: [
    {
      title: "Insights",
      description: "Live and on-demand modules to get you up to speed on Web3.",
      image: insightIcon.src,
    },
    {
      title: "Access",
      description: "Live and on-demand modules to get you up to speed on Web3.",
      image: accessIcon.src,
    },
    {
      title: "Immersion",
      description: "Live and on-demand modules to get you up to speed on Web3.",
      image: immersionIcon.src,
    },
  ],
};
